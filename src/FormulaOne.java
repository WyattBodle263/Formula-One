...
// allocate space for ret
    ...
    private static Vector<Vector<Vector<Integer>>> duplicate3x3(Vector<Vector<Vector<Integer>>> inputImg){
        ...
        for(int i = 0; i < inputImg.size() * 3; i++){
            Vector<Vector<Integer>> tempRow = new Vector<Vector<Integer>>();
            for(int j = 0; j < inputImg.size() * 3; i++){
                Vector<Integer> tempPixel = new Vector<Integer>();
                tempPixel.addElement(0);
                tempPixel.addElement(0);
                tempPixel.addElement(0);
        ...
        for(int i = 0; i < ret.size(); i++){
            for(int j = 0; j < ret.elementAt(i).size(); j++){
                ret.elementAt(i).elementAt(j).set(0, inputImg.elementAt(i % inputImg.size()).elementAt(j % inputImg.elementAt(0).size()).elementAt(0));
                ret.elementAt(i).elementAt(j).set(1, inputImg.elementAt(i % inputImg.size()).elementAt(j % inputImg.elementAt(0).size()).elementAt(1));
                ret.elementAt(i).elementAt(j).set(2, inputImg.elementAt(i % inputImg.size()).elementAt(j % inputImg.elementAt(0).size()).elementAt(2));
            }
        }
        return ret;
    }
    ...
    private static void trackDraw(){
        ...
        for(int i = 0; i < rectHeight; i++){
            ...
            for(int j = 0; j < rectWidth; j++){
                ...
                int indexi = cameray - (rectHeight - i);
                int indexj = camerax - (rectWidth - j + (int)(0.5 + ((double)rectWidth/2.0)));
                ...
                tempRGB.addElement(trackMatrix.elementAt(indexi).elementAt(indexj).elementAt(0));
                tempRGB.addElement(trackMatrix.elementAt(indexi).elementAt(indexj).elementAt(1));
                tempRGB.addElement(trackMatrix.elementAt(indexi).elementAt(indexj).elementAt(2));
